...
final class HavlakLoopFinder {
  ...
  private void initAllNodes() {
    ...
    cfg.getBasicBlocks().forEach(
        new ForEachInterface<BasicBlock>() {
          @Override
          public void apply(BasicBlock bb) {
  ...
  public void findLoops() {
    ...
    for (int w = size - 1; w >= 0; w--) {
      ...
      if (nodeW != null) {
        ...
        nodePool.forEach(
            new ForEachInterface<UnionFindNode>() {
              @Override
              public void apply(UnionFindNode niter) {
  ...
  private void stepEProcessNonBackPreds(final int w, final Vector<UnionFindNode> nodePool,
    ...
    nonBackPreds.at(x.getDfsNumber()).forEach(
        new ForEachInterface<Integer>() {
          @Override
